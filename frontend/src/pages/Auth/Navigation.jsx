...
import "./Navigation.css"; // Make sure to include your custom styles
...
const Navigation = () => {
  ...
  return (
    ...
    >
      ...
      {/* Right section with login modal */}
      <div className="relative">
        ...
        {dropdownOpen && userInfo && (
          <ul
          className={`absolute right-0 mt-2 mr-4 space-y-2 bg-white text-gray-600  ${
        
  !userInfo.isAdmin ? "-top-16" : "-top-16"
} h-[50vh] w-[30vw] z-[1000]`}
          >
            {userInfo.isAdmin && (
              <>
                 <li>
